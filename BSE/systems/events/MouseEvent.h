...
namespace BSE {
	...
	class BSE_API MouseMovedEvent : public Event {
	public:
	...
	class BSE_API MouseScrolledEvent : public Event {
	public:
	...
	class BSE_API MouseButtonEvent : public Event {
	public:
	...
	class BSE_API MouseButtonPressed : public MouseButtonEvent {
	public:
	...
	class BSE_API MouseButtonReleased : public MouseButtonEvent {
	public:
